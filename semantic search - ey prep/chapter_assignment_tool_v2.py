...
# -*- coding: utf-8 -*-
"""
Chapter Assignment Tool v2 for EY Document Processing

Streamlined interface focused on markdown content viewing and chapter assignment.
Removes PDF viewing functionality and optimizes layout for better usability.
"""
...
def main():
    ...
    app.setApplicationName("Chapter Assignment Tool v2")
